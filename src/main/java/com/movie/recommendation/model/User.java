...
public class User {
    ...
    public String toString() {
        return "User{" + "id=" + id + ", username=" + username + ", password=" + password + ", favoriteMovies=" + favoriteMovies + '}';
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.id, this.username, this.password, this.favoriteMovies);
    }
}
